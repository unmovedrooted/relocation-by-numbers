      ...
      <div className="min-w-0 space-y-6">
        <section className={panel} aria-labelledby="plan-household-heading">
          ...
          {values.state === "ny" && <label className="mb-4 flex items-start gap-2 text-sm" htmlFor="plan-ny-contract">
            ...
            <span>I accept a fixed-2026 New York/NYC pre-credit estimate, not a future-law forecast. It excludes credits, itemization and other NY adjustments. My IRA funds were contributed before retirement; private pensions are qualifying periodic pensions; government pensions are fully eligible for the selected exemption; investment income is fully NY taxable. Yonkers, inherited funds and cross-border income are not supported. Workplace-plan/nonqualified Roth distributions and pension income in the year of turning 59½ may block calculation.</span>
          </label>}
        ...
        <details className={panel}>
          ...
          <div className="mt-4 space-y-4 text-sm leading-6 text-slate-600 dark:text-slate-400">
            <div>
              ...
              <p className="mt-1">This screen models Florida, Texas or restricted New York scenarios and the supported account contracts described in the account editor. New York requires explicit acceptance of a fixed-2026 pre-credit scenario; it does not forecast enacted future changes. Workplace contributions use verified scenario limits. IRA contributions use the restricted annual eligibility model with explicit coverage and deduction choices. Unsupported account or tax cases are blocked rather than approximated. Do not use these results to make financial decisions.</p>
