// /lib/caribbeanTax/countries/gp.ts

import type { CountryTaxConfig } from "../types";
import { TAX_YEAR_LABEL } from "../types";

export const GP_TAX_CONFIG: CountryTaxConfig = {
  code: "GP",
  name: "Guadeloupe",
  currency: "EUR",
  ...
  disclaimer:
    "Guadeloupe is part of the French income tax system for these purposes. This calculator does not yet model the full French schedule, household quotient system, or overseas-specific reductions.",
  tags: ["french_system"],
  ...
  sources: [
    {
      ...
      notes:
        "Used to confirm that Guadeloupe is included in France for income tax purposes.",
    },
    {
  ...
  scenarios: {
    local: {
      ...
      confidence: "pending",
      notes: [
        "Guadeloupe follows the French income tax system for this calculator's classification purposes.",
