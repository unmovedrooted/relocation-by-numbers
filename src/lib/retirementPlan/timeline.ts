...
export type TimelineInput = Readonly<{
  ...
  connecticutContract?: HouseholdYearInput["connecticutContract"];
  vermontContract?: HouseholdYearInput["vermontContract"];
  montanaContract?: HouseholdYearInput["montanaContract"];
  rhodeIslandContract?: HouseholdYearInput["rhodeIslandContract"];
  californiaContract?: HouseholdYearInput["californiaContract"];
  virginiaContract?: HouseholdYearInput["virginiaContract"];
  arizonaContract?: HouseholdYearInput["arizonaContract"];
  georgiaContract?: HouseholdYearInput["georgiaContract"];
  northCarolinaContract?: HouseholdYearInput["northCarolinaContract"];
  ...
  washingtonContract?: HouseholdYearInput["washingtonContract"];
  alabamaContract?: HouseholdYearInput["alabamaContract"];
  arkansasContract?: HouseholdYearInput["arkansasContract"];
  delawareContract?: HouseholdYearInput["delawareContract"];
  kansasContract?: HouseholdYearInput["kansasContract"];
  kentuckyContract?: HouseholdYearInput["kentuckyContract"];
  nebraskaContract?: HouseholdYearInput["nebraskaContract"];
  westVirginiaContract?: HouseholdYearInput["westVirginiaContract"];
  idahoContract?: HouseholdYearInput["idahoContract"];
  louisianaContract?: HouseholdYearInput["louisianaContract"];
  michiganContract?: HouseholdYearInput["michiganContract"];
  oklahomaContract?: HouseholdYearInput["oklahomaContract"];
  wisconsinContract?: HouseholdYearInput["wisconsinContract"];
