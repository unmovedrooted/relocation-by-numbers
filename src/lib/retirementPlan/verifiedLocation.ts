...
export const VERIFIED_RETIREMENT_STATES: readonly string[] = ["fl", "tx", "ny", "md", "in", "dc", "il", "nj", "pa", "co", "nm", "mn", "ut", "ct", "vt"];
...
export function verifiedRetirementLocation(state: string, cityId = "") {
  ...
  const PRE_CREDIT_NAMES: Partial<Record<StateCode, string>> = { ny: "New York", md: "Maryland", in: "Indiana", dc: "DC", il: "Illinois", nj: "New Jersey", pa: "Pennsylvania", co: "Colorado", nm: "New Mexico", mn: "Minnesota", ut: "Utah", ct: "Connecticut", vt: "Vermont" };
