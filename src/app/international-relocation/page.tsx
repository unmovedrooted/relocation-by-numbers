          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-4 space-y-3 text-sm sm:text-base text-slate-600 dark:text-slate-300">
                ...
                <p>
                  ...
                  Mexico City, Seoul, Busan, Tokyo, Singapore, Bangkok, Kuala Lumpur, Dubai,
                  Abu Dhabi, Ho Chi Minh City, Jakarta, and major US cities including New York,
                  Los Angeles, Miami, Chicago, Austin, Dallas, Seattle, Nashville, and Charlotte.
                </p>
              </div>
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950/60">
                  ...
                  <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                    Rent, utilities, groceries, transportation, and healthcare costs
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950/60">
                  ...
                  <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                    Deposit, first month rent, visa fees, flights, setup costs, and a
            ...
            <div className="rounded-2xl border border-blue-200/70 bg-blue-50 p-5 dark:border-blue-900/60 dark:bg-blue-950/30">
              ...
              <div className="mt-4 space-y-3 text-sm text-slate-700 dark:text-slate-300">
                ...
                <p>
                  The current-city side is best treated as a normalized comparison baseline.
                  Enter destination-based budget assumptions to make the destination view
                  coherent, while the current side serves as a planning reference rather than
                  an exact snapshot of what you spend today.
                </p>
                <p>
        ...
        <section className="rounded-2xl bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.10)] ring-1 ring-slate-200/70 dark:bg-slate-900 dark:ring-slate-800">
          ...
          <dl className="mt-5 space-y-5 text-sm text-slate-600 dark:text-slate-300">
            <div>
              ...
              <dd className="mt-1">
                Based on the cost indexes in this calculator, the most affordable destinations
                are Jakarta, Ho Chi Minh City, Kuala Lumpur, and Bangkok — each running
                roughly 40–55% of the cost of an average US city. Lisbon and Porto are the
                most affordable European options at around 80–95% of US costs.
              </dd>
            </div>
            <div>
              <dt className="font-semibold text-slate-900 dark:text-white">
              ...
              <dd className="mt-1">
                A common planning rule is 3–6 months of destination expenses saved before
                you move, plus one-time costs like visa fees, flights, a security deposit,
                and setup costs. The calculator estimates your full upfront budget based on
                your chosen city. Most destinations fall between $3,000 and $8,000 in
                one-time costs, not including an emergency buffer.
              </dd>
            </div>
            <div>
              <dt className="font-semibold text-slate-900 dark:text-white">
              ...
              <dd className="mt-1">
                Yes. The calculator applies country-specific resident personal income tax
                models where available. Dubai and Abu Dhabi have no personal income tax.
                Portugal, the UK, Canada, Japan, Singapore, South Korea, Thailand, Malaysia,
                Vietnam, Indonesia, and Mexico all use progressive tax models based on
                published resident rates as of early 2026.
              </dd>
            </div>
            <div>
              <dt className="font-semibold text-slate-900 dark:text-white">
                What is the cheapest English-speaking country to move to?
              </dt>
              <dd className="mt-1">
                Among the destinations in this calculator, Jamaica and Trinidad and Tobago
                (covered in the Caribbean calculator) are the most affordable English-speaking
                options. Internationally, Malaysia offers strong English proficiency at a low
                cost index, making Kuala Lumpur a popular choice for remote workers and retirees.
              </dd>
            </div>
            <div>
              <dt className="font-semibold text-slate-900 dark:text-white">
              ...
              <dd className="mt-1">
                Yes. Enter your current city on the left and a destination on the right to
                see a side-by-side comparison of rent, taxes, monthly expenses, and take-home
                pay. The planning signals section will show you the equivalent salary you
                would need in your destination to maintain the same lifestyle.
              </dd>
            </div>
          </dl>
        </section>
