// /lib/caribbeanTax/countries/bq-sa.ts

import type { CountryTaxConfig } from "../types";
import { TAX_YEAR_LABEL } from "../types";

export const BQ_SA_TAX_CONFIG: CountryTaxConfig = {
  code: "BQ-SA",
  name: "Saba",
  currency: "USD",
  ...
  scenarios: {
    local: {
      ...
      confidence: "high",
      notes: [
        "Saba personal income tax is modeled using the official 2026 BES rate schedule.",
    ...
    remote: {
      ...
      notes: [
        ...
        "This file does not yet add a country-specific foreign-source exemption model for Saba.",
...
export default BQ_SA_TAX_CONFIG;