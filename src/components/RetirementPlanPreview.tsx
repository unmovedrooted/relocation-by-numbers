      ...
      <div className="min-w-0 space-y-6">
        <section className={panel} aria-labelledby="plan-household-heading">
          ...
          {values.state === "hi" && <label className="mb-4 flex items-start gap-2 text-sm" htmlFor="plan-hi-contract">
            ...
            <span>I accept a Hawaii pre-credit estimate using the enacted graduated schedule (1.40% to 11.00% at $9,600/$14,400/$19,200/$24,000/$36,000/$48,000/$125,000/$175,000/$225,000/$275,000/$325,000 single, doubled for married filing jointly) applied after the latest published (2025) standard deduction ($4,400 single/$8,800 married filing jointly, held pending Hawaii&apos;s multi-year Act 46 (SLH 2024) tax cut schedule for 2026 and later years) and a $1,144 personal exemption per person. Social Security and Railroad Retirement Tier 1 benefits are fully exempt. Income entered as annual pension, of any pensionType, is treated as an exempt qualifying employer-funded pension or public retirement system benefit, since this planner cannot distinguish a noncontributory pension from a contributory one; this planner&apos;s aggregate 401(k)/IRA/annuity distribution figure remains fully taxable. Only single and married-filing-jointly are supported. Itemized deductions and credits are excluded.</span>
          </label>}
          {values.state === "me" && <label className="mb-4 flex items-start gap-2 text-sm" htmlFor="plan-me-contract">
            ...
            <span>I accept a Maine pre-credit estimate using the enacted 2026 graduated schedule (5.8%/6.75%/7.15% at $27,400/$64,850 single, $54,850/$129,750 married filing jointly) plus the enacted 2% surcharge on Maine taxable income above $1,000,000 single/$1,500,000 married filing jointly, applied after the 2026 standard deduction ($15,700 single/$31,400 married filing jointly, plus $2,050 single or $1,650 married per person per age-65-or-blind condition) and a $5,300 per-person personal exemption. Social Security and Railroad Retirement benefits are fully exempt. Each owner&apos;s own pension income of any pensionType, plus a share of this planner&apos;s aggregate 401(k)/IRA/annuity distribution figure, is excluded up to a $49,824 per-owner cap reduced by that owner&apos;s own gross Social Security and Railroad Retirement benefits, at any age, but Maine&apos;s separate, fully uncapped military retirement pay exemption is not modeled. Only single and married-filing-jointly are supported. Itemized deductions and other credits are excluded.</span>
          </label>}
