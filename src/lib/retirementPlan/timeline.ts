...
export type TimelineInput = Readonly<{
  ...
  hawaiiContract?: HouseholdYearInput["hawaiiContract"];
  maineContract?: HouseholdYearInput["maineContract"];
  northDakotaContract?: HouseholdYearInput["northDakotaContract"];
  oregonContract?: HouseholdYearInput["oregonContract"];
